    ...
    <>
      <div className="">
        ...
        <div className="top">
          ...
          <div>
            <div className="fiyat">
              <p id="tam-fiyat" className="barlow">
                85.50₺
              </p>{" "}
              <div className="rate-part">
                <p className="barlow">4.9</p>
                <p className="barlow">(200)</p>
              </div>
            </div>
            <p className="barlow" id="info">
              ...
              İtalyan kökenli lezzetli bir yemektir. Küçük bir pizza bazen
              pizzetta denir.
            </p>
          </div>
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div>
              <h3 className="barlow">Ek Malzemeler</h3>
              <p className="barlow">En Fazla 10 Malzeme Seçebilirsiniz.5₺</p>
              <div className="check-box barlow">
